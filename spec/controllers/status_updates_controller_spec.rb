  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved status_update as @status_update" do
        ...
        post :create, {:status_update => { "status" => "invalid value" }}, valid_session
        assigns(:status_update).should be_a_new(StatusUpdate)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested status_update" do
        ...
        StatusUpdate.any_instance.should_receive(:update_attributes).with({ "status" => "" })
        put :update, {:id => status_update.to_param, :status_update => { "status" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the status_update as @status_update" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        StatusUpdate.any_instance.stub(:save).and_return(false)
        put :update, {:id => status_update.to_param, :status_update => { "status" => "invalid value" }}, valid_session
        assigns(:status_update).should eq(status_update)
      end
