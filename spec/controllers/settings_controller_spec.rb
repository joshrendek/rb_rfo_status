  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved setting as @setting" do
        ...
        post :create, {:setting => { "setting_key" => "invalid value" }}, valid_session
        assigns(:setting).should be_a_new(Setting)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested setting" do
        ...
        Setting.any_instance.should_receive(:update_attributes).with({ "setting_key" => "MyString" })
        put :update, {:id => setting.to_param, :setting => { "setting_key" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the setting as @setting" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Setting.any_instance.stub(:save).and_return(false)
        put :update, {:id => setting.to_param, :setting => { "setting_key" => "invalid value" }}, valid_session
        assigns(:setting).should eq(setting)
      end
